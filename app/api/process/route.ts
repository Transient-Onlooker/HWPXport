...
// 모델 상수
const MODEL_ROUTER = 'gemini-flash-lite-latest';  // 복잡도 판별용 (저비용)
const MODEL_PARSER_COMPLEX = 'gemini-flash-latest';       // 정밀 파싱용 (복잡한 수식)
const MODEL_PARSER_SIMPLE = 'gemini-flash-latest';        // 빠른 파싱용 (텍스트 중심)
