...
// 모델 상수
const MODEL_ROUTER = 'gemini-2.0-flash-lite-preview';  // 복잡도 판별용 (저비용)
const MODEL_PARSER_COMPLEX = 'gemini-2.0-flash';        // 정밀 파싱용 (복잡한 수식)
const MODEL_PARSER_SIMPLE = 'gemini-1.5-flash';         // 빠른 파싱용 (텍스트 중심)
